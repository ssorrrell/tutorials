...
namespace TodoApi.Controllers
{
    ...
    [Route("api/[controller]")] //Replace [controller] with the name of the controller, which by convention is the controller class name minus the "Controller" suffix
    [ApiController] //This attribute indicates that the controller responds to web API requests. For information about specific behaviors that the attribute enables
    public class TodoItemsController : ControllerBase
    {
        ...
        public async Task<ActionResult<TodoItemDTO>> GetTodoItem(long id)
        {
            ...
            //GetTodoItem can return two different status values
