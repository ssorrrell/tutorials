...
{
    public class SchoolRebuilder : System.Data.Entity.DropCreateDatabaseAlways<SchoolContext>
    {
        protected override void Seed(SchoolContext context)
        {
            //The Seed method takes the database context object as an input parameter, and the code
            //in the method uses that object to add new entities to the database. For each entity type,
